...
public class Game {
    ...
    private static final String PATH = "C:\\Users\\phili\\Desktop\\CS61B\\CS61B_sp18\\proj2\\world.txt";
    ...
    private void setupNewGame() {
        ...
        if (seedString.equals("")) {
            wg = new WorldGenerator(WIDTH, HEIGHT, 0);
        } else {
    ...
    private void processWelcome() {
        ...
        // break after setup has been done and enter game mode
        do {
    ...
    private void renderWelcomeBoard() {
        ...
        StdDraw.text(0.5, 0.8, "CS61B: Philip Zhang");
